 ...
 * @since 2026/4/15
 */
public class JQuickImpalaDataTypeConverter implements JQuickDataTypeConverter {
    ...
    public String convert(JQuickDataTypeFamily family, JQuickDataType dataType) {
        ...
        switch (family) {
            ...
            case TIME:
                // Impala 没有单独的 TIME 类型，使用 STRING
                return "STRING";
