...
import com.github.paohaijiao.dialect.impl.JQuickPrestoDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickPrestoDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickPrestoDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return lowerUrl.startsWith("jdbc:presto:") || lowerUrl.startsWith("jdbc:trino:");
    }
