...
import com.github.paohaijiao.dialect.impl.JQuickVerticaDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickVerticaDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickVerticaDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:vertica:");
    }
