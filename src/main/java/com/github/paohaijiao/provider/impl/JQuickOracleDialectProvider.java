...
import com.github.paohaijiao.dialect.impl.JQuickOracleDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickOracleDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickOracleDialect();
    }
