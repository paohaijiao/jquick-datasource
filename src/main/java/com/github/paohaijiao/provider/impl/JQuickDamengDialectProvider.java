...
import com.github.paohaijiao.dialect.impl.JQuickDamengDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickDamengDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickDamengDialect();
    }
