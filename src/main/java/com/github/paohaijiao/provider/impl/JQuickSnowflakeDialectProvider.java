...
import com.github.paohaijiao.dialect.impl.JQuickSnowflakeDialect;
 ...
 * @since 2026/4/16
 */
public class JQuickSnowflakeDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickSnowflakeDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:snowflake:");
    }
