...
/**
 * Google BigQuery 方言提供者
 *
 * @author Martin
 * @version 1.0.0
 * @since 2026/4/15
 */
public class JQuickBigQueryDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickBigQueryDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:bigquery:");
    }
