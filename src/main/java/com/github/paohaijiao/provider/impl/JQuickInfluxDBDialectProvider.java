...
import com.github.paohaijiao.dialect.impl.JQuickInfluxDBDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickInfluxDBDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickInfluxDBDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:influxdb:");
    }
