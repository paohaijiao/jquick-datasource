...
import com.github.paohaijiao.dialect.impl.JQuickDrillDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickDrillDialectProvider implements JQuickSQLDialectProvider {
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:drill:");
    }
