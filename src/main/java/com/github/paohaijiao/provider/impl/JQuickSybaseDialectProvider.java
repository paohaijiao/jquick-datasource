...
import com.github.paohaijiao.dialect.impl.JQuickSybaseDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickSybaseDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickSybaseDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:sybase:Tds:");
    }
