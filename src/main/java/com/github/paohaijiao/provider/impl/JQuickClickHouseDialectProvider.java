...
import com.github.paohaijiao.dialect.impl.JQuickClickHouseDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickClickHouseDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickClickHouseDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:clickhouse:");
    }
