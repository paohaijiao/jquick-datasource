...
import com.github.paohaijiao.dialect.impl.JQuickPhoenixDialect;
 ...
 * @since 2026/4/16
 */
public class JQuickPhoenixDialectProvider implements JQuickSQLDialectProvider {
    @Override
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickPhoenixDialect();
    }
}
