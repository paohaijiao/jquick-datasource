...
import com.github.paohaijiao.dialect.impl.JQuickFirebirdDialect;
 ...
 * @since 2026/4/16
 */
public class JQuickFirebirdDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickFirebirdDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:firebirdsql:");
    }
