 ...
 * @since 2026/4/14
 */
public class JQuickKingbaseEsDialectProvider implements JQuickSQLDialectProvider {
    @Override
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickKingbaseESDialect();
    }
    public  boolean supports(String jdbcUrl) {
        return jdbcUrl.startsWith("jdbc:kingbase:");
    }
}
