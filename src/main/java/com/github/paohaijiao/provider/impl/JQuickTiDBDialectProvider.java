 ...
 * @since 2026/4/15
 */
public class JQuickTiDBDialectProvider implements JQuickSQLDialectProvider {
    ...
    public boolean supports(String jdbcUrl) {
        ...
        if (jdbcUrl.startsWith("jdbc:mysql://")) {
            ...
            return lowerUrl.contains("tidb") || lowerUrl.contains(":4000");
        }
        return false;
    }
