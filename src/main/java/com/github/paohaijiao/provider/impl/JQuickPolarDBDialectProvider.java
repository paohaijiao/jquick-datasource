...
import com.github.paohaijiao.dialect.impl.JQuickPolarDBDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickPolarDBDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickPolarDBDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        if (jdbcUrl.startsWith("jdbc:mysql://")) {
            ...
            return lowerUrl.contains("polardb") || lowerUrl.contains("polar");
        }
        return false;
    }
