...
/**
 * Greenplum 方言提供者
 * Greenplum 兼容 PostgreSQL 协议
 *
 * @author Martin
 * @version 1.0.0
 * @since 2026/4/15
 */
public class JQuickGreenplumDialectProvider implements JQuickSQLDialectProvider {
    ...
    public JQuickSQLDialect createDialect() {
        return new JQuickGreenplumDialect();
    }
    ...
    public boolean supports(String jdbcUrl) {
        ...
        if (jdbcUrl.startsWith("jdbc:postgresql://")) {
            ...
            return lowerUrl.contains("greenplum") || lowerUrl.contains("gpdb");
        }
        return false;
    }
