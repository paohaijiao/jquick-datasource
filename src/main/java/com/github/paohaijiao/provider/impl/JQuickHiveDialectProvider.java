...
import com.github.paohaijiao.dialect.impl.JQuickHiveDialect;
 ...
 * @since 2026/4/15
 */
public class JQuickHiveDialectProvider implements JQuickSQLDialectProvider {
    ...
    public boolean supports(String jdbcUrl) {
        ...
        return jdbcUrl.startsWith("jdbc:hive2:");
    }
