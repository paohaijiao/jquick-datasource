 ...
 * OceanBase 数据类型转换器
 */
class JQuickOceanBaseDataTypeConverter implements JQuickDataTypeConverter {
    ...
    public String convert(JQuickDataTypeFamily family, JQuickDataType dataType) {
        if (JQuickOceanBaseDialect.MODE_ORACLE.equals(mode)) {
