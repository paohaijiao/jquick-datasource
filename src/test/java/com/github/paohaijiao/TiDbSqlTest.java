...
import com.github.paohaijiao.dialect.impl.JQuickTiDBDialect;
...
public class TiDbSqlTest {
    ...
    public    void testBuildCreateTable() {
        ...
        JQuickTiDBDialect dialect = new JQuickTiDBDialect();
    ...
    public void testBuildInsert() {
        ...
        JQuickGaussDBDialect  dialect = new JQuickGaussDBDialect();
